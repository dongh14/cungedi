...
export default async function RestaurantReviewPage({
  ...
  return (
    <AppShell
      ...
      description="当前这一步会用简单、受限、best-effort 的服务端提取读取公开页面信息。自动提取目前仍以美食来源最稳妥，并新增了强结构化住宿页、景点页、购物页和玩乐页的保守支持；其他地点仍然可以继续手动保存。"
        ...
        <div className="space-y-4">
          <PlaceholderCard
            ...
            items={[
              ...
              "所有 V1 字段都仍可手动修改；美食会继续预填推断出来的菜系或类型，住宿、景点、购物和玩乐只会在强证据足够时预填分类与类型细分。",
              "点击保存前不会写入任何地点记录。",
            ]}
          />
          <PlaceholderCard
